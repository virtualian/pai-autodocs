...
- Vercel Web Analytics integration via `@vercel/analytics/react` Root wrapper
...
- Algorithm, Telos, and Fabric documentation surfaced in sidebar with full Diataxis coverage
...
- Expanded sidebar navigation for all four audience roles
